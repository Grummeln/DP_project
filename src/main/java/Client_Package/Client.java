...
public class Client {
    ...
    public static class ClientBuilder{
        ...
        private ClientBuilder accountNumber(String accountNumber){
            this.accountNumber = accountNumber;
            return this;
        }
        private ClientBuilder type(Account.TYPE type){
            this.type = type;
            return this;
        }

        private ClientBuilder sum(int sum){
            this.sum = sum;
            return this;
        }
    ...
    public void addAccount(Account.TYPE type, String accountNumber, double sum) throws Exception {
        Account c = null;
